...
if __name__ == "__main__":
    ...
    # plot parameters ------------------------------------------------------------------------------
    error_to_plot_id = "precision_at_10"  # "approximation_error" 'precision_at_10' 'precision_at_10' 'approximation_error_at_10' 'kendals_tau'
    orders_to_plot = [2, 3]  # [ORDER] [1, 2, 3] None [0] (only with 'approximation_error')
