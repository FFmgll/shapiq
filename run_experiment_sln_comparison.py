...
if __name__ == "__main__":
    ...
    for iteration in range(1, ITERATIONS + 1):
        ...
        for MIN_INTERACTIONS, MAX_INTERACTIONS in MIN_MAX_INTERACTIONS:
            ...
            # SAVE paths ---------------------------------------------------------------------------
            SAVE_NAME = '_'.join((
                START_TIME, game_name,"comp", str(N_FEATURES), str(SHAPLEY_INTERACTION_ORDER),
                            ...
                            for pairwise in PAIRWISE_LIST:
                                ...
                                approximation_errors[
                                    '_'.join((
                                        ...
                                        str(approximator.average_std_S),
                                ...
                                # Const.
                                approximated_interactions = copy.deepcopy(approximator.result_no_sampling)
                                results['_'.join((run_id3, 'const'))] = copy.deepcopy(
                                    approximated_interactions)
                                approximation_errors[
                                    '_'.join((
                                        run_id3, 'const',
